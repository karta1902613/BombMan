...
public class MainFrame extends JFrame {
            ...
            public void keyPressed(KeyEvent e)
            {
                ...
                switch( i )
                {
                    ...
                    case 96: //0
                        ...
                        if(countBombT<twobombQua&&jlbsCode[y2][x2]!=6){
                            switch (queueBombT){
                                case 1:
                                    //System.out.println("2P放置炸彈1");
                                    countBombT++;
                                    queueBombT=2;
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(tyb2+i<=7) { //往下炸
                            if (jlbsCode[tyb2 + i][txb2] == 0 || jlbsCode[tyb2 + i][txb2] > 2) {
                                if (jlbsCode[tyb2 + i][txb2] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb2 + i][txb2] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(txb2-i>=0) { //往左炸
                            if (jlbsCode[tyb2][txb2-i] == 0 || jlbsCode[tyb2][txb2-i] > 2) {
                                if (jlbsCode[tyb2][txb2-i] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb2][txb2-i] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(tyb3+i<=7) { //往下炸
                            if (jlbsCode[tyb3 + i][txb3] == 0 || jlbsCode[tyb3 + i][txb3] > 2) {
                                if (jlbsCode[tyb3 + i][txb3] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb3 + i][txb3] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(txb3-i>=0) { //往左炸
                            if (jlbsCode[tyb3][txb3-i] == 0 || jlbsCode[tyb3][txb3-i] > 2) {
                                if (jlbsCode[tyb3][txb3-i] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb3][txb3-i] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(tyb4+i<=7) { //往下炸
                            if (jlbsCode[tyb4 + i][txb4] == 0 || jlbsCode[tyb4 + i][txb4] > 2) {
                                if (jlbsCode[tyb4 + i][txb4] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb4 + i][txb4] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(txb4-i>=0) { //往左炸
                            if (jlbsCode[tyb4][txb4-i] == 0 || jlbsCode[tyb4][txb4-i] > 2) {
                                if (jlbsCode[tyb4][txb4-i] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb4][txb4-i] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(tyb5+i<=7) { //往下炸
                            if (jlbsCode[tyb5 + i][txb5] == 0 || jlbsCode[tyb5 + i][txb5] > 2) {
                                if (jlbsCode[tyb5 + i][txb5] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb5 + i][txb5] == 4) {
                                    tPdie();
                                }
                    ...
                    for(int i=1;i<twofireQua+1;i++){
                        if(txb5-i>=0) { //往左炸
                            if (jlbsCode[tyb5][txb5-i] == 0 || jlbsCode[tyb5][txb5-i] > 2) {
                                if (jlbsCode[tyb5][txb5-i] == 3) { //下
                                    oPdie();
                                } else if (jlbsCode[tyb5][txb5-i] == 4) {
                                    tPdie();
                                }
    ...
    public void map2(){
        ...
        jlbs[0][2].setIcon(imgeStone2); jlbsCode[0][2]=1;
